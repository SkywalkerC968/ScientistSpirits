...
define config.name = _("ScientistSpirits")
...
define gui.about = _p("""
    ...
    小组成员：陈威宇 林昱晓 姜宇扬 王麒霖

    小组分工：

    陈威宇【组长】——规划项目进度，编写项目程序，审核校对工作

    林昱晓——前五个场景的剧本撰写，选项设计，以及对应科学家精神概括

    姜宇扬——后五个场景的剧本撰写，选项设计，以及对应科学家精神概括

    王麒霖——GUI界面素材整理，游戏场景图片制作
    ...
    Heart Of Courage-Two Steps From Hell&Thomas

    Canon in D major, instrumental arrangement - Pachelbel
...
define build.name = "ScientistSpirits"
...
define config.save_directory = "ScientistSpirits-1711972940"
