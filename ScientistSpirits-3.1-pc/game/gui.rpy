...
define gui.accent_color = '#004a93'

## 当文本按钮既未被选中也未被悬停时使用的颜色。
define gui.idle_color = '#0000A0'
...
define gui.choice_button_borders = Borders(70, 13, 70, 13, 20, 7, 20, 7)
#define gui.choice_button_text_font = gui.text_font
define gui.choice_button_text_font = "DaKai.ttf"
